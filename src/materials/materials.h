...
namespace Materials {
     ...
     */
    enum class Mat {Graphene, StrainedGraphene, MoS2, WS2, MoSe2, WSe2, Invalid};
    /**
     ...
     */
    const std::array<std::array<double, 2>, 2>& lattice(const Mat mat);
    /**
     ...
     */
    const double&                               orbital_pos(const Mat mat, const int idx, const int dim);
  ...
  // overloaded strain method (bonding dist only)
	double
	intralayer_term(const int orbital_row, const int orbital_col,
                    const std::array<int, 2>& vector, const double r,
                    const Mat mat);

  // overloaded strain method (exact implementation from strain modeling paper)
  double
  intralayer_term(const int orbit_row, const int orbit_col,
