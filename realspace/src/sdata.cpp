...
Sdata::Sdata(std::vector<std::vector<double> > _a, std::vector<int> _types, std::vector<std::vector<double> > _pos, std::vector<int> _min, std::vector<int> _max, int _mat, int _boundary_condition) {
    a = _a;
    min_shape = _min;
    max_shape = _max;
    atom_types = _types;
