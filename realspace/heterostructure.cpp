...
Heterostructure::Heterostructure(std::vector<Sheet> sheets_in,std::vector<double> angles_in,std::vector<double> heights_in) {
...
Heterostructure::Heterostructure(const Heterostructure& orig) {
}

Heterostructure::~Heterostructure() {
}

void Heterostructure::setIndex(){
    int k_total = 0;
...
int Heterostructure::getMaxIndex(){
    return max_index;
}

void Heterostructure::setShift(int sheet, std::vector<double> b){
    shifts[sheet] = b;
}

double Heterostructure::posAtomIndex(int k, int dim){
    if (k > max_index){
        return 0;
    }
